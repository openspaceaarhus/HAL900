...
void aes_256_init    (aes_256_context_t *context, const uint8_t key[32]);
...
void aes_192_init    (aes_192_context_t *context, const uint8_t key[24]);
...
void aes_128_init    (aes_128_context_t *context, const uint8_t key[16]);
